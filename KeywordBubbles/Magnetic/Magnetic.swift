...
//    open var allowsMultipleSelection: Bool = true
    ...
    open var numberOfSelections: Int = 1
    ...
    func configure() {
        ...
        DispatchQueue.main.asyncAfter(deadline: .now() + 2) { [weak self] in
            ...
            wkSelf.magneticField.strength = 0
        }
...
extension Magnetic {
    ...
    override open func touchesEnded(_ touches: Set<UITouch>, with event: UIEvent?) {
        ...
        if node.isSelected {
            ...
            if self.selectedChildren.count > (self.numberOfSelections - 1), let selectedNode = selectedChildren.last {
