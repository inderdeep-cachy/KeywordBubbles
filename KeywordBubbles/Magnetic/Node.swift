...
//    public lazy var innerCircle: SKShapeNode = { [unowned self] in
//        let circle = SKShapeNode(circleOfRadius: (self.radius ?? 20) - 20)
//        circle.fillColor = self.color
//        circle.strokeColor = .clear
//        circle.blendMode = .multiply
//        circle.isAntialiased = true
//
//        var image = UIImage(named: "inner_tick_small")
//        if self.radius == 80 { image = UIImage(named: "inner_tick_medium") }
//        if self.radius == 100 { image = UIImage(named: "inner_tick_large") }
//        circle.fillTexture = SKTexture(image: image)
//
//        self.insertChild(circle, at: 0)
//        return circle
//    }()
...
//    }
     ...
     */
    open var selectedScale: CGFloat = 1
    ...
    struct Defaults {
        ...
        static let marginScale = CGFloat(65)
...
//        _ = self.innerCircle
    ...
    public func update(radius: CGFloat, withLabelWidth width: CGFloat? = nil) {
        ...
        self.path = path
        self.label.width = (width ?? radius) - 40
        self.radius = radius
        regeneratePhysicsBody(withPath: path)
    }
...
//            let body = SKPhysicsBody(polygonFrom: path.copy(using: &transform)!)
            let body = SKPhysicsBody(circleOfRadius: (self.radius ?? 1) * marginScale)
            body.allowsRotation = false
//            body.friction = 100/40 * (radius ?? 1)
            body.friction = 10
